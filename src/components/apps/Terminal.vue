                ...
                <div class="flex flex-col flex-grow w-full h-full">
                    <div :id="directive.id" v-for="directive in directiveStack" :key="directive.id">
                        <div class="flex w-full h-5">
                            <div class="relative text-md font-bold text-ubt-green">you@rdpstudio</div>
        ...
        data() {
            return {
                ...
                childDirectories: {
                    ...
                    skills: ["Vue.js", "Python", "Node.JS"],
                    projects: ["rdpstudio.top", "More at https://github.com/rdp-studio"],
